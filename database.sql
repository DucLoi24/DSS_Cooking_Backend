...
(
    ...
    id integer NOT NULL DEFAULT nextval('favorite_recipes_new_id_seq'::regclass),
    CONSTRAINT favorite_recipes_pkey PRIMARY KEY (id),
    CONSTRAINT favorite_recipes_user_recipe_unique UNIQUE (user_id, recipe_id)
);
...
(
    ...
    category ingredient_category_enum DEFAULT 'other'::ingredient_category_enum,
...
(
    ...
    CONSTRAINT pantry_items_user_id_ingredient_id_key UNIQUE (user_id, ingredient_id)
);
...
(
    ...
    difficulty difficulty_enum NOT NULL DEFAULT 'medium'::difficulty_enum,
    cooking_time_minutes integer,
    author_id integer NOT NULL,
    status recipe_status_enum NOT NULL DEFAULT 'private'::recipe_status_enum,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
...
(
    ...
    CONSTRAINT shopping_list_items_user_id_ingredient_id_key UNIQUE (user_id, ingredient_id)
);
...
ALTER TABLE IF EXISTS public.favorite_recipes
    ADD CONSTRAINT fk_recipe FOREIGN KEY (recipe_id)
...
ALTER TABLE IF EXISTS public.ingredients
    ADD CONSTRAINT fk_submitted_by FOREIGN KEY (submitted_by_id)
    REFERENCES public.auth_user (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS public.pantry_items
    ADD CONSTRAINT fk_ingredient FOREIGN KEY (ingredient_id)
...
ALTER TABLE IF EXISTS public.recipes
    ...
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS idx_recipes_author_id
