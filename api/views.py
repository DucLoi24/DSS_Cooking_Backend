...
# --- VIEW CHO NGUYÊN LIỆU (ĐÃ SỬA LỖI) ---
class IngredientListCreateView(generics.ListCreateAPIView):
    ...
    def perform_create(self, serializer):
        # SỬA LỖI Ở ĐÂY: Dùng giá trị 'pending' cho đúng với ENUM của bảng ingredients
        serializer.save(submitted_by=self.request.user, status='pending')

# --- CÁC VIEW CÒN LẠI (Đã được kiểm tra và giữ nguyên) ---
